...
public class APIControler {
	...
	@RequestMapping(value = "/initiatives/list", method = RequestMethod.GET, consumes = "application/json")
	public List<Map<String, Object>> getListInitiative()
	{
		return initiativeService.getList();
	}

	@RequestMapping(value = "/initiatives/listByName", method = RequestMethod.GET, consumes = "application/json")
	public List<Map<String, Object>> getListByName(@RequestParam("name") String name)
	{
		return initiativeService.getListByName(name);
	}
	
	@RequestMapping(value = "/initiatives/initiative", method = RequestMethod.GET, consumes = "application/json")
	public Initiative getInitiativeById(@RequestParam("id") int id)
	{
		return initiativeService.getInitiativeById(id);
	}
	
	@RequestMapping(value = "/initiatives/initiative", method = RequestMethod.POST, consumes = "application/json")
	public Initiative insertInitiative(@RequestParam("name") String name, @RequestParam("targetDate") GregorianCalendar targetDate,
									...
									@RequestParam("targetAmount") int targetAmount, @RequestParam("createBy") String createBy)
	{
		return initiativeService.insert(name, targetDate, description.orElse(""), 
								targetArea, location, imagen.orElse(null), 
								targetAmount, "0", createBy, "random");
	}
	
	@RequestMapping(value = "/initiatives/initiative", method = RequestMethod.PUT, consumes = "application/json")
	...
	@RequestMapping(value = "/initiatives/initiative", method = RequestMethod.DELETE, consumes = "application/json")
	public void deleteInitiative(@RequestParam("id") int id)
	{
		initiativeService.delete(id);
	}
	
	@RequestMapping(value = "/initiatives/usersJoined", method = RequestMethod.GET, consumes = "application/json")
	...
	@RequestMapping(value = "/initiatives/usersJoined", method = RequestMethod.POST, consumes = "application/json")
	public UserJoinInitiative insertUsersJoined(@RequestParam("idInitiative") int idInitiative, @RequestParam("userEmail") String userEmail,
											@RequestParam("type") int type)
	{
		return joinInitiativeService.insert(idInitiative, userEmail, type);
	}
	
	@RequestMapping(value = "/initiatives/usersJoined", method = RequestMethod.PUT, consumes = "application/json")
	...
	@RequestMapping(value = "/initiatives/usersJoined", method = RequestMethod.DELETE, consumes = "application/json")
	...
	@RequestMapping(value = "/users/list", method = RequestMethod.GET, consumes = "application/json")
	public List<Map<String, Object>> getListUser()
	{
		return userService.getList();
	}
	
	@RequestMapping(value = "/users/user", method = RequestMethod.GET, consumes = "application/json")
	...
	@RequestMapping(value = "/users/user", method = RequestMethod.PUT, consumes = "application/json")
	...
	@RequestMapping(value = "/users/user", method = RequestMethod.DELETE, consumes = "application/json")
	public void deleteUser(@RequestParam("id") int id)
	{
		userService.delete(id);
	}
	
	@RequestMapping(value = "/users/initiatives/created", method = RequestMethod.GET, consumes = "application/json")
	...
	@RequestMapping(value = "/users/initiatives/joined", method = RequestMethod.GET, consumes = "application/json")
	...
	@RequestMapping(value = "/users/followed/list", method = RequestMethod.GET, consumes = "application/json")
	...
	@RequestMapping(value = "/users/followers/list", method = RequestMethod.GET, consumes = "application/json")
	...
	@RequestMapping(value = "/users/followed", method = RequestMethod.POST, consumes = "application/json")
	...
	@RequestMapping(value = "/users/followed", method = RequestMethod.DELETE, consumes = "application/json")
	...
	@RequestMapping(value = "/users/reviews/list", method = RequestMethod.GET, consumes = "application/json")
	...
	@RequestMapping(value = "/users/reviews", method = RequestMethod.POST, consumes = "application/json")
	public UserReviewUser insertReview(@RequestParam("userEmail") String userEmail, @RequestParam("userReviewEmail") String userReviewEmail,
									@RequestParam("review") Optional<String> review, @RequestParam("stars") int stars)
	{
		UserReviewUser reviewUser = reviewUserService.insert(userEmail, userReviewEmail, review.orElse(""), stars);
		return reviewUser;
	}
}
